...
contains(MCACOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += MCACOIN_NEED_QT_PLUGINS
...
contains(MCACOIN_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = MeccaCoin-qt_test
DEFINES += MCACOIN_QT_TEST
}
...
macx:ICON = src/qt/res/icons/MeccaCoin.icns
macx:TARGET = "MeccaCoin-Qt"
